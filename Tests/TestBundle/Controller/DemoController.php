...
class DemoController extends Controller
{
    ...
    public function authorizeCodeAction(Request $request)
    {
        ...
        $userManager = $this->get('authbucket_push.model_manager.factory')->getModelManager('user');
        ...
        $url = Request::create($request->getUriForPath('/push/authorize'), 'GET', $parameters)->getUri();
    ...
    public function grantTypeAuthorizationCodeAction(Request $request)
    {
        ...
        $crawler = $client->request('POST', '/api/v1.0/push/token', $parameters, array(), $server);
